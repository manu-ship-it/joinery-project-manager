...
export async function processVoiceCommand(speech: string, callSid?: string): Promise<string> {
  try {
    ...
    try {
      const command: VoiceCommand & { updateContext?: SessionContext } = JSON.parse(aiResponse)
...
async function executeCommand(command: VoiceCommand, context: SessionContext): Promise<string> {
  try {
...
async function createProject(params: SessionContext & { project_name?: string; project_address?: string; budget?: number }): Promise<string> {
  try {
...
async function getProject(params: SessionContext & { project_name?: string }): Promise<string> {
  try {
...
async function addTask(params: SessionContext & { task_description?: string; project_name?: string }): Promise<string> {
  try {
    ...
    let foundProject: { id: string; project_name: string; client: string } | null = null
...
async function updateMaterial(params: SessionContext & { material_name?: string; order_status?: string; order_number?: string }): Promise<string> {
  try {
    ...
    const updateData: { is_ordered?: boolean; order_number?: string } = {}
...
async function getStatus(params: SessionContext & { project_name?: string }): Promise<string> {
  try {
...
async function listProjects(params: SessionContext & { status?: string; limit?: number }): Promise<string> {
  try {
